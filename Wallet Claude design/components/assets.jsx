        ...
        <div className="card-hero" style={{ padding: '22px 22px 20px', overflow: 'hidden', position: 'relative' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, justifyContent: 'flex-start' }}>
              <span className="num" style={{ fontSize: 40, fontWeight: 700, color: 'var(--p-200)', letterSpacing: '-0.02em' }}>48,217</span>
              <span className="num" style={{ fontSize: 20, color: 'var(--p-200)', opacity: 0.6 }}>.80</span>
              <RiyalGlyph size={20} color="var(--p-200)" />
            </div>
