...
function Phone({ children, screen = 'home', onTab, showFab = true, onFab }) {
  return (
    <div style={{
      width: 390, height: 844, borderRadius: 54, overflow: 'hidden',
      position: 'relative', background: '#000',
      boxShadow: '0 0 0 2px #1f1f2a, 0 0 0 12px #0a0a12, 0 40px 80px rgba(0,0,0,0.5)',
    }}>
      ...
      <div style={{
        ...
        width: 135, height: 5, borderRadius: 3, background: 'rgba(255,255,255,0.4)', zIndex: 50,
      }} />
    </div>
  );
}
