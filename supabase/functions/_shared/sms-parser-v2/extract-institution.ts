...
const INSTITUTIONS: Inst[] = [
  { id: 'alrajhi',  name: 'Al Rajhi',    country: 'SA', aliases: ['alrajhi', 'al rajhi', 'rajhi', 'الراجحي', 'مصرف الراجحي'] },
  { id: 'snb',      name: 'SNB',         country: 'SA', aliases: ['snb', 'saudi national bank', 'الأهلي', 'الاهلي', 'البنك الأهلي'] },
  { id: 'alinma',   name: 'Al Inma',     country: 'SA', aliases: ['alinma', 'al inma', 'inma', 'الإنماء', 'الانماء', 'مصرف الإنماء', 'al inma bank'] },
  { id: 'riyad',    name: 'Riyad',       country: 'SA', aliases: ['riyad bank', 'riyadbank', 'بنك الرياض', 'الرياض'] },
  { id: 'sab',      name: 'SAB',         country: 'SA', aliases: ['sab', 'sabb', 'البنك السعودي البريطاني'] },
  { id: 'bsf',      name: 'BSF',         country: 'SA', aliases: ['bsf', 'banque saudi fransi', 'البنك السعودي الفرنسي'] },
  { id: 'anb',      name: 'ANB',         country: 'SA', aliases: ['anb', 'arab national', 'البنك العربي الوطني'] },
  { id: 'albilad',  name: 'Al Bilad',    country: 'SA', aliases: ['albilad', 'al bilad', 'البلاد', 'بنك البلاد'] },
  { id: 'aljazira', name: 'Al Jazira',   country: 'SA', aliases: ['aljazira', 'al jazira', 'الجزيرة', 'بنك الجزيرة'] },
  { id: 'saib',     name: 'SAIB',        country: 'SA', aliases: ['saib', 'البنك السعودي للاستثمار'] },
  { id: 'gib',      name: 'GIB',         country: 'SA', aliases: ['gib', 'gulf international'] },
  { id: 'stcbank',  name: 'STC',         country: 'SA', aliases: ['stc bank', 'stcbank', 'بنك stc'] },
